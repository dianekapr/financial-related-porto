...
const dict = {
  ...
  searchTxPlaceholder: { id: 'Cari catatan atau kategori...', en: 'Search note or category...' },
  noSearchResults: { id: 'Tidak ada transaksi yang cocok', en: 'No matching transactions' },

  recurringTitle: { id: 'TRANSAKSI BERULANG', en: 'RECURRING TRANSACTIONS' },
  recurringAddBtn: { id: '+ Berulang', en: '+ Recurring' },
  recurringEmpty: { id: 'Belum ada transaksi berulang', en: 'No recurring transactions yet' },
  recurringFrequencyDaily: { id: 'Harian', en: 'Daily' },
  recurringFrequencyWeekly: { id: 'Mingguan', en: 'Weekly' },
  recurringFrequencyMonthly: { id: 'Bulanan', en: 'Monthly' },
  recurringNextRun: { id: 'Berikutnya', en: 'Next' },
  recurringPaused: { id: 'Dijeda', en: 'Paused' },
  recurringPause: { id: 'Jeda', en: 'Pause' },
  recurringResume: { id: 'Lanjutkan', en: 'Resume' },
  recurringModalTitle: { id: 'TRANSAKSI BERULANG BARU', en: 'NEW RECURRING TRANSACTION' },
  recurringFrequency: { id: 'Frekuensi', en: 'Frequency' },
  recurringStartDate: { id: 'Mulai', en: 'Starts' },
  recurringSubmit: { id: 'Simpan Aturan', en: 'Save Rule' },
  confirmDeleteRecurring: { id: 'Hapus transaksi berulang ini?', en: 'Delete this recurring transaction?' },
  recurringNotice: {
    id: 'Dibuat otomatis saat kamu buka Dashboard, bukan persis di tanggal jatuh tempo.',
    en: 'Created automatically when you open the Dashboard, not exactly on the due date.',
  },

  budgetBreadcrumb: { id: 'Pengelolaan', en: 'Management' },
  budgetTitle: { id: 'BUDGET', en: 'BUDGET' },
  budgetTotalThisMonth: { id: 'Total Budget', en: 'Total Budget' },
  ...
  transferLabel: { id: 'Transfer', en: 'Transfer' },
  walletTransferBtn: { id: 'Transfer', en: 'Transfer' },
  walletTransferTitle: { id: 'TRANSFER ANTAR WALLET', en: 'TRANSFER BETWEEN WALLETS' },
  walletTransferFrom: { id: 'Dari', en: 'From' },
  walletTransferTo: { id: 'Ke', en: 'To' },
  walletTransferNeedTwo: { id: 'Butuh minimal 2 wallet untuk transfer', en: 'You need at least 2 wallets to transfer' },
  walletTransferSubmit: { id: 'Transfer Sekarang', en: 'Transfer Now' },
  ...
  analyticsWallet: { id: 'Dompet', en: 'Wallet' },
  ...
  editTxTitle: { id: 'EDIT TRANSAKSI', en: 'EDIT TRANSACTION' },
  editTxSubmit: { id: 'Simpan Perubahan', en: 'Save Changes' },

  settingsTitle: { id: 'PENGATURAN', en: 'SETTINGS' },
  settingsTheme: { id: 'Tema', en: 'Themes' },
  settingsThemeHint: { id: 'Pilih tema, lalu pilih mode Day atau Night', en: 'Pick a color theme, then choose Day or Night mode' },
